...
int main() 
{
    ...
    while(i < 150)
    {
        ...
        if(design_under_test->Output != out.Output) {
            ...
            std::cout << "D0 = " << (uint16_t)inp.D0 << "; ";
            std::cout << "D1 = " << (uint16_t)inp.D1 << "; ";
            std::cout << "D2 = " << (uint16_t)inp.D2 << "; ";
            std::cout << "D3 = " << (uint16_t)inp.D3 << "; ";
            std::cout << "D4 = " << (uint16_t)inp.D4 << "; ";
            std::cout << "D5 = " << (uint16_t)inp.D5 << "; ";
            std::cout << "D6 = " << (uint16_t)inp.D6 << "; ";
            std::cout << "D7 = " << (uint16_t)inp.D7 << "; ";
            std::cout << "D8 = " << (uint16_t)inp.D8 << "; ";
            std::cout << "D9 = " << (uint16_t)inp.D9 << "; ";
