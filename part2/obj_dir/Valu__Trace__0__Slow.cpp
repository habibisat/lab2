...
VL_ATTR_COLD void Valu___024root__trace_init_sub__TOP__0(Valu___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+4,"Result", false,-1, 8,0);
    tracep->pushNamePrefix("alu ");
    tracep->declBus(c+1,"X", false,-1, 7,0);
    tracep->declBus(c+2,"Y", false,-1, 7,0);
    tracep->declBit(c+3,"op", false,-1);
    tracep->declBus(c+4,"Result", false,-1, 8,0);
    tracep->declBus(c+5,"temporary", false,-1, 8,0);
...
VL_ATTR_COLD void Valu___024root__trace_full_sub_0(Valu___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->fullSData(oldp+4,(vlSelf->Result),9);
    tracep->fullSData(oldp+5,((0x1ffU & ((IData)(vlSelf->op)
                                          ? ((IData)(vlSelf->X) 
                                             - (IData)(vlSelf->Y))
                                          : ((IData)(vlSelf->X) 
                                             + (IData)(vlSelf->Y))))),9);
